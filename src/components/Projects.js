...
const Projects = () => {
  const projectList = [
    {
      name: 'Medico -   Online Medical Store',
      description: 
      ...
      link: 'https://github.com/Kunalborse24/Medico-Online-Medical-Store'
    },
    {
      name: 'Slice of Heaven-Pizza Shop',
description: 
  'A full-stack web application developed using React.js for the frontend and Express.js for the backend, serving as a REST API. ' +
  'Users can browse the menu, customize orders, and securely log in using JSON Web Tokens for authorization. ' +
  'Data entered by users is secured with CryptoJS, ensuring privacy and security. The application features a responsive design, ' +
  'crafted with Bootstrap 5 to enhance user experience. MySQL is used for database management, enabling efficient data handling.',
link: 'https://github.com/Kunalborse24/Slice-of-Heaven-Pizza-Shop'
    },
    {
